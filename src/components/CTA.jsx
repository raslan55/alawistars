...
export default function CTA() {
  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 text-center md:text-left">
    ...
    <div className="flex-1 w-full">
      <h2 className="text-base sm:text-lg lg:text-4xl   font-bold text-white">
        Get Started Today
      </h2>
      <h3 className="text-2xl sm:text-3xl font-semibold mt-2 leading-snug">
    ...
    <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
      ...
      >
        ...
        <div className="text-left leading-tight">
          <p className="text-sm font-bold">Call Us any time</p>
          <p className="text-lg font-bold">011 4760967</p>
        </div>
      </a>
