...
const FloatingWhatsAppButton = ({ phoneNumber, message }) => {
  ...
  return (
    ...
    <a
      ...
      className="fixed bottom-6 right-6 bg-[#41c052] hover:bg-[#41c052] text-white p-4 rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:scale-110 flex items-center justify-center z-50 focus:outline-none focus:ring-4 focus:ring-green-300"
