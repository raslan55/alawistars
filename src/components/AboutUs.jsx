    ...
    <section className="bg-gray-50 py-16 px-4 md:px-16">
      <div className="max-w-6xl mx-auto text-right">
        ...
        <div className="text-gray-800 leading-loose text-lg space-y-6 mb-6">
          <p>
            انطلقت <span className="font-semibold text-blue-700">نجوم العلاوي لنظم الكمبيوتر</span> عام ١٩٩٤ لتوفر للمجتمع والاقتصاد السعودي الطامح للنمو والريادة آنذاك
            الحلول البرمجية والأنظمة الالكترونية، بالإضافة لأنواع متعددة من الخدمات والمنتجات التقنية المتطورة التي تتواكب مع تطلعات الشركات والمؤسسات الخاصة في ذلك الوقت.
          </p>

          <p>
            وساهمت الشركة بدور فعال في تسهيل الإدارة، تحسين الإنتاج، وحوكمة وضبط العمل. ومنذ لحظة انطلاقها، نجحت في كسب ثقة عملائها وترسيخ مكانتها كشريك تقني موثوق لدى العديد من الجهات الحكومية والخاصة.
          </p>

          <p>
            واصلت الشركة تقديم أداء متميز ومنتجات تقنية متطورة أثرت منظومة الإدارة والتكنولوجيا في المملكة، مما ساعدها على تحقيق قفزات كبيرة في حجم مخرجاتها وهوامش أرباحها ومستوى تميزها.
          </p>

          <p>
            اعتمدت نجوم العلاوي على منهجية عمل دائمة التطور، ترتكز على رضا العملاء وتقديم خدمات ومنتجات مثالية، مما جعلها مزود الخدمة الأول لأكثر من <strong>١٠ آلاف شركة ومؤسسة</strong> داخل وخارج المملكة.
          </p>
