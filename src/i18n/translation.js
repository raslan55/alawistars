...
const resources = {
  en: {
    translation: {
      ...
      admin_stats: "Site Stats",
      admin_settings: "Site Settings",
      admin_logout: "Logout",
      admin_save_all: "SAVE ALL CHANGES NOW",
      admin_edit: "Edit",
      admin_delete: "Delete",
      admin_add: "Add",
      admin_update: "Update",
      admin_cancel: "Cancel",
      admin_success_msg: "Action completed successfully",
      admin_error_msg: "Something went wrong",
      admin_search: "Search...",
      admin_image_label: "Image",
      admin_image_hint: "Click to upload image",
      admin_active: "Active",
      ...
      admin_bio_en: "Bio (EN)",
      admin_bio_ar: "Bio (AR)",
      admin_role_en: "Role (EN)",
      admin_role_ar: "Role (AR)",
      admin_date: "Date",
      admin_features: "Features",
      admin_add_feature: "Add Feature",
      admin_icon_name: "Icon Name (e.g. FaTools)",
      admin_slug: "Slug (URL identifier)",
      ...
      Prod_Zatca_Compliant: "100% Compliant with ZATCA strictly",
      Prod_Book_Demo: "Book a Demo",
      Prod_See_Action: "See System in Action",
      Prod_Why_System: "Why do you need this system?",
      Prod_Diff_Desc: "The difference between traditional methods and fully automated professional systems.",
      Prod_Trad_Methods: "Traditional Methods",
      Prod_Trad_Err1: "Slow, manual data entry consuming team time",
      Prod_Trad_Err2: "Repeated human errors causing financial drain",
      Prod_Trad_Err3: "Difficulty matching ZATCA compliance requirements",
      Prod_Trad_Err4: "Lack of visibility due to no real-time reporting",
      Prod_With_System: "With",
      Prod_Auto_Adv1: "Full automation saving hundred of hours monthly",
      Prod_Auto_Adv2: "100% precision in accounting and numbers",
      Prod_Auto_Adv3: "Direct & automatic ZATCA tax compliance",
      Prod_Auto_Adv4: "Real-time dashboard and reports for decisions",
      Prod_Start_Org: "Start organizing your accounts now",
      Prod_Feat_Success: "Features built for success",
      Prod_Feat_Desc: "We deliver solutions that translate directly into saved time and increased profit.",
      Prod_Micro_Benefit_0: "Save 50% reporting time",
      Prod_Micro_Benefit_1: "Easier accurate management",
      Prod_Micro_Benefit_2: "Fast execution without errors",
      Prod_Micro_Benefit_3: "Seamless tax linking",
      Prod_Micro_Benefit_4: "Total control dashboard",
      Prod_Micro_Benefit_5: "Sustainable scale",
      Prod_See_30mins: "See the system in 30 mins",
      Prod_Partners_Trust: "Success Partners Trust Us",
      Prod_Clients: "Happy Clients",
      Prod_Success_Rate: "Success Rate",
      Prod_ZATCA_Badge: "ZATCA Compliant",
      Prod_Years_Exp: "Years Experience",
      Prod_Limited_Time: "Fast Instant Setup - Limited Time",
      Prod_Ready_Next: "Ready to take your business to next level?",
      Prod_Use_Cases_Title: "Key product use cases across industries",
      Prod_Use_Cases_Desc: "Powerful business software for Saudi firms, from startups to multi-branch enterprises.",
      Prod_ERP_Title: "Integrated ERP modules — connect every business function",
      Prod_ERP_Desc: "A central platform that syncs your operations and automates workflows across departments.",
      Prod_Use_Cases_Tag: "Key use cases",
      Prod_Use_Cases_Card: "Business focus",
      ...
      "Prod_What_Label_Default": "System Overview",
      ...
      "Prod_What_P2_inventory-system": "The system allows you to track item movement, manage suppliers, and issue barcode invoices, plus multi-branch support and real-time inventory valuation, eliminating deficits and operational losses.",

      "Prod_What_Title_real-estate-management": "What is Sanmar Property Management System?",
      "Prod_What_P1_real-estate-management": "A comprehensive solution that simplifies managing properties, landlords, and tenants on a single, integrated accounting platform.",
      "Prod_What_P2_real-estate-management": "The system offers full automation for lease contracts, expiration alerts, and tracks payments and expenses for each building, boosting collection efficiency and reducing tenant defaults.",

      "Prod_What_Title_furnished-apartments": "What is Sanmar Furnished Apartments System?",
      "Prod_What_P1_furnished-apartments": "A specialized and innovative system for easily managing hotel and furnished apartment reservations and guest services.",
      "Prod_What_P2_furnished-apartments": "The system supports daily and monthly bookings, issues ZATCA-compliant invoices, and provides detailed reports on occupancy rates and room status, ensuring the highest possible returns for your facility.",

      "Prod_What_Title_medical-system": "What is Sanmar Medical Management System?",
      "Prod_What_P1_medical-system": "An integrated medical system that connects clinics, doctors, pharmacies, and patient accounts in a secure environment.",
      "Prod_What_P2_medical-system": "It allows you to manage appointments, electronic medical records, and direct integration with insurance companies (Waseel and others) to send claims instantly, saving medical staff time and raising care quality.",

      "Prod_What_Title_car-maintenance": "What is Sanmar Car Maintenance System?",
      "Prod_What_P1_car-maintenance": "A specialized program that manages the workflow of maintenance workshops from car entry to delivery.",
      "Prod_What_P2_car-maintenance": "The system opens job cards, tracks issued spare parts, and monitors technician performance, plus sending SMS to customers and issuing tax invoices, organizing work and raising workshop efficiency.",

      "Prod_What_Title_car-sales": "What is Sanmar Car Sales System?",
      "Prod_What_P1_car-sales": "The ideal solution for car showrooms and dealerships to effectively manage inventory, sales, and installment systems.",
      "Prod_What_P2_car-sales": "The system covers all car details and specifications, manages installments and delayed payments tracking, in addition to full accounting integration and calculating profit and loss for each car individually.",

      "Prod_What_Title_hr-system": "What is Sanmar HR System?",
      "Prod_What_P1_hr-system": "A fully automated and integrated system for managing personnel, payroll, and attendance.",
      "Prod_What_P2_hr-system": "The system manages employee files, contracts, vacations, and calculates social insurance and allowances, ensuring accurate monthly payroll generation and compliance with Saudi labor laws.",

      "Prod_What_Title_telecom-system": "What is Sanmar Telecom System?",
      "Prod_What_P1_telecom-system": "An advanced technology for connecting your company branches and synchronizing real-time data between them and the main headquarters.",
      "Prod_What_P2_telecom-system": "The system offers multiple connection and synchronization options tailored to your business size, allowing top management to view inventory, sales, and accounts of all branches from a single screen with the highest encryption standards.",

      "Prod_What_Title_services-system": "What is Sanmar Public Services System?",
      "Prod_What_P1_services-system": "A flexible program for precisely managing service companies, laundries, and service provider offices.",
      "Prod_What_P2_services-system": "The system allows pricing various services, issuing quotations and tax invoices, tracking service execution, and calculating profits, giving you total control over your revenues and expenses.",

      "Prod_What_Title_fuel-station": "What is Sanmar Fuel Station System?",
      "Prod_What_P1_fuel-station": "A dedicated system for managing fuel stations and pumps, and automatically monitoring tanks.",
      "Prod_What_P2_fuel-station": "The system records pump readings, calculates evaporation losses, and manages credit customer accounts (companies and individuals), in addition to tracking station revenues and additional sales from one place.",
      Features: "Features",
  ...
  ar: {
    translation: {
      ...
      client_name_25: "        مؤسسة سعد عمر الوعل ",
      admin_stats_published: "المقالات المنشورة",
      ...
      admin_save_all: "حفظ جميع التغييرات الآن",
      admin_edit: "تعديل",
      admin_delete: "حذف",
      admin_add: "إضافة",
      admin_update: "تحديث",
      admin_cancel: "إلغاء",
      admin_success_msg: "تمت العملية بنجاح",
      admin_error_msg: "حدث خطأ ما",
      admin_search: "بحث...",
      admin_image_label: "الصورة",
      admin_image_hint: "انقر لتحميل الصورة",
      admin_active: "نشط",
      admin_sort_order: "ترتيب العرض",
      admin_title_en: "العنوان (EN)",
      admin_title_ar: "العنوان (AR)",
      admin_desc_en: "الوصف (EN)",
      admin_desc_ar: "الوصف (AR)",
      admin_name_en: "الاسم (EN)",
      admin_name_ar: "الاسم (AR)",
      admin_bio_en: "السيرة الذاتية (EN)",
      admin_bio_ar: "السيرة الذاتية (AR)",
      admin_role_en: "المنصب (EN)",
      admin_role_ar: "المنصب (AR)",
      admin_date: "التاريخ",
      admin_features: "المميزات",
      admin_add_feature: "إضافة ميزة",
      admin_icon_name: "اسم الأيقونة (مثال: FaTools)",
      admin_slug: "المعرف (Slug)",
      ...
      Prod_Diff_Desc: "الفرق بين العمل بالطرق التقليدية القديمة وبين الاعتماد على نظام مؤتمت واحترافي يخدم طموحاتك.",
      ...
      Prod_Auto_Adv2: "دقة متناهية 100% في الحسابات، الأرقام والموارد",
      Prod_Auto_Adv3: "امتثال ضريبي ومطابقة رقمية زكوية (ZATCA) بشكل آلي",
      Prod_Auto_Adv4: "لوحة تحكم وتقارير لحظية توفر لك رؤية كاملة لاتخاذ القرار",
      Prod_Start_Org: "ابدأ تنظيم حساباتك الآن",
      Prod_Feat_Success: "خصائص ومميزات صُممت لتقودك للنجاح",
      Prod_Feat_Desc: "نحن لا نقدم مجرد مميزات تقنية، بل نقدم حلولاً تترجم مباشرة إلى أرباح ووقت مكتسب لقطاع أعمالك.",
      Prod_Micro_Benefit_0: "وفر 50% من وقت التقارير شهرياً",
      Prod_Micro_Benefit_1: "إدارة مبسطة، سهلة، وأكثر دقة",
      Prod_Micro_Benefit_2: "سرعة الإنجاز بدون أدنى أخطاء",
      Prod_Micro_Benefit_3: "ربط ضريبي سلس وبدون عناء",
      Prod_Micro_Benefit_4: "تحكم كلي من خلال شاشة واحدة",
      Prod_Micro_Benefit_5: "نمو مستدام ومخاطر معدومة",
      Prod_See_30mins: "شاهد النظام يعمل خلال 30 دقيقة",
      Prod_Partners_Trust: "انضم لنخبة من شركاء النجاح الذين يثقون بنا",
      Prod_Clients: "عميل ومؤسسة",
      Prod_Success_Rate: "نسبة نجاح",
      Prod_ZATCA_Badge: "مرخّص ومطابق ZATCA",
      ...
      Prod_Start_Now: "ابدأ النظام الآن",
      ...
      "Prod_What_Label_Default": "تعريف البرنامج",
      ...
      "Prod_What_P1_real-estate-management": "حل شامل يسهل عليك إدارة العقارات، الملاك، والمستأجرين في منصة واحدة متكاملة محاسبياً.",
      "Prod_What_P2_real-estate-management": "يقدم النظام أتمتة كاملة لعقود الإيجار، وتنبيهات بانتهاء العقود، ومتابعة الدفعات والمصروفات الخاصة بكل مبنى، مما يرفع كفاءة التحصيل ويقلل من تعثرات المستأجرين.",

      "Prod_What_Title_furnished-apartments": "ما هو نظام سنمار للشقق المفروشة؟",
      "Prod_What_P1_furnished-apartments": "نظام متخصص ومبتكر لإدارة حجوزات الشقق الفندقية والمفروشة وخدمات النزلاء بسهولة تامة.",
      "Prod_What_P2_furnished-apartments": "يدعم النظام الحجوزات اليومية والشهرية، ويصدر فواتير متوافقة مع متطلبات الزكاة، مع تقديم تقارير مفصلة عن نسب الإشغال وحالة الغرف، لضمان أعلى عوائد ممكنة لمنشأتك.",

      "Prod_What_Title_medical-system": "ما هو نظام سنمار للإدارة الطبية؟",
      "Prod_What_P1_medical-system": "نظام طبي متكامل يربط بين العيادات، الأطباء، الصيدلية، وحسابات المرضى في بيئة آمنة.",
      "Prod_What_P2_medical-system": "يتيح لك إدارة المواعيد، والسجلات الطبية الإلكترونية، والربط المباشر مع شركات التأمين (وصيل وغيرها) لإرسال المطالبات فورياً، مما يوفر وقت الطاقم الطبي ويرفع جودة الرعاية.",

      "Prod_What_Title_car-maintenance": "ما هو نظام سنمار لورش صيانة السيارات؟",
      "Prod_What_P1_car-maintenance": "برنامج متخصص يدير دورة عمل ورش الصيانة من دخول السيارة وحتى تسليمها للعميل.",
      "Prod_What_P2_car-maintenance": "يقوم النظام بفتح كروت العمل، وتتبع قطع الغيار المصروفة، ومراقبة أداء الفنيين، بالإضافة إلى إرسال رسائل نصية للعملاء وإصدار فواتير ضريبية، مما ينظم العمل ويرفع كفاءة الورشة.",

      "Prod_What_Title_car-sales": "ما هو نظام سنمار لمعارض السيارات؟",
      "Prod_What_P1_car-sales": "الحل الأمثل لمعارض ووكالات السيارات لإدارة المخزون، المبيعات، ونظام التقسيط بفعالية.",
      "Prod_What_P2_car-sales": "يغطي النظام كافة تفاصيل السيارة ومواصفاتها، ويدير عمليات التقسيط وتتبع الدفعات المتأخرة، بالإضافة إلى الربط المحاسبي الكامل وحساب الأرباح والخسائر لكل سيارة على حدة.",

      "Prod_What_Title_hr-system": "ما هو نظام سنمار للموارد البشرية؟",
      "Prod_What_P1_hr-system": "نظام متكامل ومؤتمت بالكامل لإدارة شؤون الموظفين، الرواتب، والحضور والانصراف.",
      "Prod_What_P2_hr-system": "يدير النظام ملفات الموظفين، والعقود، والإجازات، وحساب التأمينات الاجتماعية والبدلات، مما يضمن دقة استخراج مسيرات الرواتب شهرياً وتوافقها مع أنظمة العمل السعودية.",

      "Prod_What_Title_telecom-system": "ما هو نظام سنمار للاتصالات وربط الفروع؟",
      "Prod_What_P1_telecom-system": "تقنية متطورة لربط فروع شركتك ومزامنة البيانات اللحظية بينها وبين المركز الرئيسي.",
      "Prod_What_P2_telecom-system": "يقدم النظام عدة خيارات للربط والمزامنة تناسب حجم أعمالك، مما يتيح للإدارة العليا الاطلاع على مخزون ومبيعات وحسابات كافة الفروع من شاشة واحدة وبأعلى معايير التشفير والأمان.",

      "Prod_What_Title_services-system": "ما هو نظام سنمار للخدمات العامة؟",
      "Prod_What_P1_services-system": "برنامج مرن لإدارة الشركات الخدمية والمغاسل ومكاتب تقديم الخدمات بكل دقة.",
      "Prod_What_P2_services-system": "يتيح النظام تسعير الخدمات المختلفة، وإصدار عروض الأسعار والفواتير الضريبية، ومتابعة تنفيذ الخدمات وحساب أرباحها، مما يمنحك سيطرة كاملة على إيراداتك ومصروفاتك.",

      "Prod_What_Title_fuel-station": "ما هو نظام سنمار لمحطات الوقود؟",
      "Prod_What_P1_fuel-station": "نظام مخصص لإدارة محطات المحروقات والمضخات ومراقبة الخزانات بشكل آلي.",
      "Prod_What_P2_fuel-station": "يقوم النظام بتسجيل قراءات المضخات، وحساب الفواقد من التبخر، وإدارة حسابات العملاء الآجلين (الشركات والأفراد)، بالإضافة لمتابعة إيرادات المحطة والمبيعات الإضافية من مكان واحد.",
      Features: "المواصفات",
